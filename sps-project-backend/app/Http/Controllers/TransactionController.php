...
use App\Models\TauxEchange; // This should match your actual model name
...
class TransactionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'taux_id' => 'required|exists:definie_prixes,id',
        ...
        $tauxData = DB::table('definie_prixes')->where('id', $validated['taux_id'])->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        // Récupérer le taux de change
        $tauxData = DB::table('definie_prixes')->where('id', $request->taux_id)->first();
